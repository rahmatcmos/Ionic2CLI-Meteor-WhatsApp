...
```diff
@@ -23,3 +23,7 @@
 ┊23┊23┊  type?: MessageType
 ┊24┊24┊  ownership?: string;
 ┊25┊25┊}
+┊  ┊26┊
+┊  ┊27┊export interface User extends Meteor.User {
+┊  ┊28┊  profile?: Profile;
+┊  ┊29┊}
```
[}]: #
...
+┊  ┊12┊import { NewChatComponent } from '../pages/chats/new-chat';
 ┊12┊13┊
 ┊13┊14┊@NgModule({
 ┊14┊15┊  declarations: [
```
...
@@ -12,6 +12,7 @@
 ┊12┊12┊  title?: string;
 ┊13┊13┊  picture?: string;
 ┊14┊14┊  lastMessage?: Message;
+┊  ┊15┊  memberIds?: string[];
 ┊15┊16┊}
 ┊16┊17┊
 ┊17┊18┊export interface Message {
```
[}]: #
...
+┊  ┊ 4┊import { Chats, Messages, Users } from 'api/collections';
 ...
 ┊ 6┊ 6┊import { MessagesPage } from '../messages/messages';
 ┊ 7┊ 7┊import { ChatsOptionsComponent } from './chats-options';
 ┊ 8┊ 8┊import { NewChatComponent } from './new-chat';
